...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    enable: true,
    src: "assets/images/banar.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
    position: "center", // Equivalent to object-position, only supports 'top', 'center', 'bottom'. 'center' by default
    credit: {
      enable: true, // Display the credit text of the banner image
      text: "碓氷峠", // Credit text to be displayed
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "はなみすきー",
			url: "https://misskey.flowers/@Tokuyama", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "柚木とくやま",
	bio: "末期の静鉄狂。動画を作ったり、モデリングしている。最近は伺かにお熱で、ゴーストを作ろうか悩んでる。",
	links: [
		{
			name: "Misskey",
			icon: "emojione-monotone:white-flower", // Visit https://icones.js.org/ for icon codes
		...
		},
		{
			...
			// You will need to install the corresponding icon set if it's not already included
			// `pnpm add @iconify-json/<icon-set-name>`
			url: "https://discord.gg/95bHKQjZXF",
		},
	],
};
